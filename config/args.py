...
def parse_args():
    ...
    # PPO_GBRL params
    parser.add_argument('--pg_algo', type=str)
    parser.add_argument('--pg_lr', type=str)
    parser.add_argument('--stop_pg_lr', type=float)
    parser.add_argument('--pg_beta_1', type=float)
    parser.add_argument('--pg_beta_2', type=float)
    parser.add_argument('--pg_eps', type=float)
    parser.add_argument('--pg_shrinkage', type=float)

    parser.add_argument('--vf_algo', type=str)
    parser.add_argument('--vf_lr', type=str)
    parser.add_argument('--stop_vf_lr', type=float)
    parser.add_argument('--vf_beta_1', type=float)
    parser.add_argument('--vf_beta_2', type=float)
    parser.add_argument('--vf_eps', type=float)
    parser.add_argument('--vf_shrinkage', type=float)
...
def get_defaults(args, defaults):
    ...
    # args.algo_type = args.algo_type if args.algo_type else 'dqn_gbrl'
    # args.algo_type = args.algo_type if args.algo_type else 'a2c_nn'
    # args.algo_type = args.algo_type if args.algo_type else 'dqn_nn'
    ...
    # args.env_name = args.env_name if args.env_name else 'Krull-ramNoFrameskip-v4'
    # args.env_name = args.env_name if args.env_name else 'Breakout-ramNoFrameskip-v4'
    # args.env_name = args.env_name if args.env_name else 'MiniGrid-Empty-Random-5x5-v0'
    # args.env_name = args.env_name if args.env_name else 'academy_corner'
    # args.env_name = args.env_name if args.env_name else 'Asteroids-ramNoFrameskip-v4'
    ...
    args.pg_algo = args.pg_algo if args.pg_algo is not None else tree_optimizer_defaults['pg_optimizer']['algo']
    args.pg_lr = args.pg_lr if args.pg_lr is not None else tree_optimizer_defaults['pg_optimizer']['lr']
    args.vf_algo = args.vf_algo if args.vf_algo is not None else tree_optimizer_defaults['value_optimizer']['algo']
    args.vf_lr = args.vf_lr if args.vf_lr is not None else tree_optimizer_defaults['value_optimizer']['lr']
        ...
        return { 
            ...
            "policy_kwargs": args.policy_kwargs if args.policy_kwargs is not None else {
                ...
                "tree_optimizer": {
                    ...
                    "pg_optimizer": {
                        "pg_algo": args.pg_algo,
                        "pg_lr": args.pg_lr,
                    }, 
                    "value_optimizer": {
                        "vf_algo": args.vf_algo,
                        "vf_lr": args.vf_lr
                    },
                },
            },
